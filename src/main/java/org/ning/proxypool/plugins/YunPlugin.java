 ...
 */
@Slf4j
@WebSitePlugin(domain = "(https|http)://www\\.ip3366\\.net.*")
public class YunPlugin extends BasePlugin {
    ...
    public void before(Response response) {
        ...
        for(Object item: nodes){
            if(item instanceof Element){
                ...
                proxyService.saveProxy(new Proxy(ip+":"+port, "云代理",  Proxy.ProxyType.getType("http")), false, true);
                log.info("get proxy {}:{} from 云代理", ip, port);
            }
        }
    }
